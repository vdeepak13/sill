...
#ifndef PRL_CONSTANT_AND_BSPT_FACTOR_HPP
#define PRL_CONSTANT_AND_BSPT_FACTOR_HPP
...
(factor_collapse_expr<bspt_factor_t<leaf_factor_t>,
  ...
  bspt_factor_t<leaf_factor_t> f(prl::collapse(expr.x_ptr,
                                               domain::empty_set,
                                               sum_tag()));
  ...
  // to constant factors.
  constant_factor<range_t> h(prl::collapse(g_ptr, domain::empty_set,
                                             sum_tag()));
  this->value = h.get_value();
}

#endif // #ifndef PRL_CONSTANT_AND_BSPT_FACTOR_HPP
