...
#include <sill/factor/random/gaussian_crf_factor_fn_builder.hpp>
#include <sill/factor/random/table_crf_factor_fn_builder.hpp>
...
namespace sill {
  ...
  struct random_crf_builder {
    ...
    table_crf_factor_fn_builder YY_rtcff_builder;

    //! Y-X table factor parameters.
    table_crf_factor_fn_builder YX_rtcff_builder;

    //! X-X table factor parameters.
    table_factor_fn_builder XX_rtff_builder;

    // Factor parameters for real variables
    //==========================================================================

    //! Y-Y Gaussian factor parameters.
    gaussian_crf_factor_fn_builder YY_rgcff_builder;

    //! Y-X Gaussian factor parameters.
    gaussian_crf_factor_fn_builder YX_rgcff_builder;

    //! X-X Gaussian factor parameters.
    moment_gaussian_fn_builder XX_rmgf_builder;
     ...
     */
    void create_model(decomposable<table_factor>& Xmodel,
     ...
     *                      corresponding X variables.
     */
    void create_model(decomposable<canonical_gaussian>& Xmodel,
