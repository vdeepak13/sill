#ifndef SILL_MODEL_RANDOM_TEMPLATED_CRF_BUILDER
#define SILL_MODEL_RANDOM_TEMPLATED_CRF_BUILDER
...
namespace sill {
  ...
  /**
   * Struct which holds parameters specifying options for
   * templated synthetic CRF models to be constructed using
   * the methods in prl/models/random.hpp.

RIGHT HERE NOW: WRITE THIS CLASS.
   *
   ...
   */
  struct random_templated_crf_builder {
...
//    void print(std::ostream& out) const;
  ...
  //! Print the options in the given random_templated_crf_builder.
//  std::ostream& operator<<(std::ostream& out, const random_templated_crf_builder& rcb);

  //! @}

} // namespace sill

#endif // #ifndef SILL_MODEL_RANDOM_TEMPLATED_CRF_BUILDER
