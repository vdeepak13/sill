#ifndef SILL_ALTERNATING_FACTOR_FUNCTOR_BUILDER_HPP
#define SILL_ALTERNATING_FACTOR_FUNCTOR_BUILDER_HPP
...
namespace sill {
  ...
  /**
   * Helper struct for alternating_factor_functor which allows
  ...
  struct alternating_factor_functor_builder
    : random_factor_functor_builder_i<alternating_factor_functor
                                      <typename RFFB::rff_type> > {

    typedef typename RFFB::rff_type                         sub_rff_type;
    typedef alternating_factor_functor<sub_rff_type> rff_type;
    ...
    void add_options(boost::program_options::options_description& desc,
      ...
      po::options_description
        sub_desc("alternating_factor_functor "
...
#endif // SILL_ALTERNATING_FACTOR_FUNCTOR_BUILDER_HPP
