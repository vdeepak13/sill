#ifndef PARALLEL_MSPLASH_BP_HPP
#define PARALLEL_MSPLASH_BP_HPP
...
namespace sill {
    ...
    public:
      ...
      */
      class blfsplash_thread : public thread {
        public:
          ...
          size_t numedgeupdates_;
          size_t numops_;
          blfsplash_thread(parallel_msplash_bp &owner, size_t scheduleid)
      ...
      */
      ...
      inline double update_message(const vertex_type& source,
        ...
        double belief_residual = norm_1(new_msg, original_msg);
  ...
  }; // End of class parallel_msplash_bp
}; // end of namespace
