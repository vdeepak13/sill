#ifndef SILL_FINITE_SEQUENCE_DATASET_HPP
#define SILL_FINITE_SEQUENCE_DATASET_HPP
...
namespace sill {
  ...
  struct finite_sequence_traits {
    typedef finite_discrete_process process_type;
  ...
  using finite_sequence_dataset =
    basic_sequence_dataset<finite_sequence_traits<T> >;
