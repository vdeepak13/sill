...
namespace sill {
   ...
   * \todo Allow finite_records to be restricted to a set of variables.
...
// TODO: FINISH RECORD VIEWS
    ...
    */
    ...
    //! Constructor for a finite_record which owns its data.
    explicit finite_record(const finite_var_vector& finite_seq)
      : finite_numbering_ptr(new std::map<finite_variable*,size_t>()),
    ...
    finite_record(const finite_record& rec)
    ...
    */
    ...
    finite_record& operator=(const finite_record& rec);
