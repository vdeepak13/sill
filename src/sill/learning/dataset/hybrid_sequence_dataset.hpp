#ifndef SILL_HYBRID_SEQUENCE_DATASET_HPP
#define SILL_HYBRID_SEQUENCE_DATASET_HPP
...
#include <sill/datastructure/hybrid_matrix.hpp>
...
namespace sill {
  ...
  using hybrid_sequence_dataset =
    basic_sequence_dataset<hybrid_sequence_traits<T> >;
