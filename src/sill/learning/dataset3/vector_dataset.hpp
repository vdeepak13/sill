...
#include <sill/learning/dataset3/raw_record_iterators.hpp>
...
namespace sill {
  ...
  */
  ...
  public:
    ...
    virtual vector_record2<T> record(size_t row) const = 0;

    //! Returns a single data point for a subset of the variables.
    virtual vector_record2<T>
    ...
    vector_record2<T> sample(const vector_var_vector& vars,
