...
namespace sill {
  ...
  class dataset 
    ...
    typedef typename finite_dataset::record_iterator finite_record_iterator;
    typedef typename vector_dataset::record_iterator vector_record_iterator;
  ...
  public:
    ...
    records(const finite_var_vector& finite_vars,
      ...
      check_initialized();
      finite_record_iterator fit, fend;
      vector_record_iterator vit, vend;
    ...
    void insert(const finite_record& r) {
      ...
      vector_dataset::insert(vector_record(r.weight));
    }
    ...
    void insert(const vector_record& r) {
      check_vector();
      finite_dataset::insert(finite_record(r.weight));
    ...
    class record_iterator
      ...
      finite_record_iterator fit;
      vector_record_iterator vit;
      record_type record;

    public:
      record_iterator() : record(*fit, *vit, 0.0) { }
      
      record_iterator(const finite_record_iterator& fit,
                      const vector_record_iterator& vit)
