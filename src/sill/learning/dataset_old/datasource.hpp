...
//    std::map<vector_variable*, size_t> vector_var_order_map;
    ...
    void convert_finite_record_old2assignment(const std::vector<size_t>& findata,
                                          finite_assignment& fa) const;

    //! Converts the given vector record data into a vector assignment.
    void convert_vector_record_old2assignment(const vec& vecdata,
                                          vector_assignment& va) const;

    //! Converts the given vector record data into a vector assignment.
    template <typename T, typename Index>
    void convert_vector_record_old2assignment(const sparse_vector<T,Index>& vecdata,
                                          vector_assignment& va) const {
