#ifndef SILL_CANONICAL_GAUSSIAN_PARAM_HPP
#define SILL_CANONICAL_GAUSSIAN_PARAM_HPP

#include <sill/math/constants.hpp>
#include <sill/math/eigen/dynamic.hpp>
#include <sill/math/eigen/logdet.hpp>
#include <sill/math/eigen/submatrix.hpp>
#include <sill/math/eigen/subvector.hpp>
#include <sill/math/numerical_error.hpp>
...
namespace sill {
  ...
  struct canonical_gaussian_join {
    ...
    canonical_gaussian_join_inplace<T, sill::plus_assign<> > f_op;
