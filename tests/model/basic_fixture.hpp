#ifndef SILL_TEST_MODEL_BASIC_FIXTURE_HPP
#define SILL_TEST_MODEL_BASIC_FIXTURE_HPP
...
struct basic_fixture {
  ...
  finite_variable* history;
  finite_variable* cvp;
  finite_variable* pcwp;
  finite_variable* hypovolemia;
  finite_variable* lvedvolume;
  finite_variable* lvfailure;
  finite_variable* strokevolume;
  finite_variable* errlowoutput;
  finite_variable* hrbp;
  finite_variable* hrekg;
  finite_variable* errcauter;
  finite_variable* hrsat;
  finite_variable* insuffanesth;
  finite_variable* anaphylaxis;
  finite_variable* tpr;
  finite_variable* expco2;
  finite_variable* kinkedtube;
  finite_variable* minvol;
  finite_variable* fio2;
  finite_variable* pvsat;
  finite_variable* sao2;
  finite_variable* pap;
  finite_variable* pulmembolus;
  finite_variable* shunt;
  finite_variable* intubation;
  finite_variable* press;
  finite_variable* disconnect;
  finite_variable* minvolset;
  finite_variable* ventmach;
  finite_variable* venttube;
  finite_variable* ventlung;
  finite_variable* ventalv;
  finite_variable* artco2;
  finite_variable* catechol;
  finite_variable* hr;
  finite_variable* co;
  finite_variable* bp;
