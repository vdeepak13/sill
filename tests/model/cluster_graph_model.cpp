...
int main(int argc, char** argv) {
  ...
  enum history_values { history_true,
                        history_false,
                        history_arity };
  variable_h history = u.new_finite_variable(history_arity);
  ...
  enum cvp_values { cvp_low,
                    ...
                    cvp_high,
                    cvp_arity };
  variable_h cvp = u.new_finite_variable(cvp_arity);
  ...
  enum pcwp_values { pcwp_low,
                     ...
                     pcwp_high,
                     pcwp_arity };
  variable_h pcwp = u.new_finite_variable(pcwp_arity);

  // Variable: hypovolemia (3)
  enum hypovolemia_values { hypovolemia_true,
                            hypovolemia_false,
                            hypovolemia_arity };
  variable_h hypovolemia = u.new_finite_variable(hypovolemia_arity);
  ...
  enum lvedvolume_values { lvedvolume_low,
                           ...
                           lvedvolume_high,
                           lvedvolume_arity };
  variable_h lvedvolume = u.new_finite_variable(lvedvolume_arity);

  // Variable: liver failure (5)
  enum lvfailure_values { lvfailure_true,
                          lvfailure_false,
                          lvfailure_arity };
  variable_h lvfailure = u.new_finite_variable(lvfailure_arity);
  ...
  enum strokevolume_values { strokevolume_low,
                             ...
                             strokevolume_high,
                             strokevolume_arity };
  variable_h strokevolume = u.new_finite_variable(strokevolume_arity);

  // Variable: low output error (7)
  enum errlowoutput_values { errlowoutput_true,
                             errlowoutput_false,
                             errlowoutput_arity };
  variable_h errlowoutput = u.new_finite_variable(errlowoutput_arity);
  ...
  enum hrbp_values { hrbp_low,
                     ...
                     hrbp_high,
                     hrbp_arity };
  variable_h hrbp = u.new_finite_variable(hrbp_arity);
  ...
  enum hrekg_values { hrekg_low,
                      ...
                      hrekg_high,
                      hrekg_arity };
  variable_h hrekg = u.new_finite_variable(hrekg_arity);

  // Variable: error in cauterization (10)
  enum errcauter_values { errcauter_true,
                          errcauter_false,
                          errcauter_arity };
  variable_h errcauter = u.new_finite_variable(errcauter_arity);
  ...
  enum hrsat_values { hrsat_low,
                      ...
                      hrsat_high,
                      hrsat_arity };
  variable_h hrsat = u.new_finite_variable(hrsat_arity);

  // Variable: insufficient anesthesia (12)
  enum insuffanesth_values { insuffanesth_true,
                             insuffanesth_false,
                             insuffanesth_arity  };
  variable_h insuffanesth = u.new_finite_variable(insuffanesth_arity);

  // Variable: anaphylaxis (13)
  enum anaphylaxis_values { anaphylaxis_true,
                            anaphylaxis_false,
                            anaphylaxis_arity };
  variable_h anaphylaxis = u.new_finite_variable(anaphylaxis_arity);
  ...
  enum tpr_values { tpr_low,
                      ...
                      tpr_high,
                      tpr_arity };
  variable_h tpr = u.new_finite_variable(tpr_arity);
  ...
  enum expco2_values { expco2_zero,
                       ...
                       expco2_high,
                       expco2_arity };
  variable_h expco2 = u.new_finite_variable(expco2_arity);

  // Variable: kinked tube (16)
  enum kinkedtube_values { kinkedtube_true,
                           kinkedtube_false,
                           kinkedtube_arity };
  variable_h kinkedtube = u.new_finite_variable(kinkedtube_arity);
  ...
  enum minvol_values { minvol_zero,
                       ...
                       minvol_high,
                       minvol_arity };
  variable_h minvol = u.new_finite_variable(minvol_arity);

  // Variable: FiO2 (18)
  enum fio2_values { fio2_low,
                       fio2_normal,
                       fio2_arity };
  variable_h fio2 = u.new_finite_variable(fio2_arity);
  ...
  enum pvsat_values { pvsat_low,
                      ...
                      pvsat_high,
                      pvsat_arity };
  variable_h pvsat = u.new_finite_variable(pvsat_arity);
  ...
  enum sao2_values { sao2_low,
                     ...
                     sao2_high,
                     sao2_arity };
  variable_h sao2 = u.new_finite_variable(sao2_arity);
  ...
  enum pap_values { pap_low,
                    ...
                    pap_high,
                    pap_arity };
  variable_h pap = u.new_finite_variable(pap_arity);

  // Variable: pulmembolus (22)
  enum pulmembolus_values { pulmembolus_true,
                            pulmembolus_false,
                            pulmembolus_arity };
  variable_h pulmembolus = u.new_finite_variable(pulmembolus_arity);

  // Variable: shunt (23)
  enum shunt_values { shunt_normal,
                      shunt_high,
                      shunt_arity };
  variable_h shunt = u.new_finite_variable(shunt_arity);
  ...
  enum intubation_values { intubation_normal,
                           ...
                           intubation_onesided,
                           intubation_arity };
  variable_h intubation = u.new_finite_variable(intubation_arity);
  ...
  enum press_values { press_zero,
                      ...
                      press_high,
                      press_arity };
  variable_h press = u.new_finite_variable(press_arity);

  // Variable: disconnect (26)
  enum disconnect_values { disconnect_true,
                           disconnect_false,
                           disconnect_arity };
  variable_h disconnect = u.new_finite_variable(disconnect_arity);
  ...
  enum minvolset_values { minvolset_low,
                          ...
                          minvolset_high,
                          minvolset_arity };
  variable_h minvolset = u.new_finite_variable(minvolset_arity);
  ...
  enum ventmach_values { ventmach_zero,
                         ...
                         ventmach_high,
                         ventmach_arity };
  variable_h ventmach = u.new_finite_variable(ventmach_arity);
  ...
  enum venttube_values { venttube_zero,
                         ...
                         venttube_high,
                         venttube_arity };
  variable_h venttube = u.new_finite_variable(venttube_arity);
  ...
  enum ventlung_values { ventlung_zero,
                         ...
                         ventlung_high,
                         ventlung_arity };
  variable_h ventlung = u.new_finite_variable(ventlung_arity);
  ...
  enum ventalv_values { ventalv_zero,
                        ...
                        ventalv_high,
                        ventalv_arity };
  variable_h ventalv = u.new_finite_variable(ventalv_arity);
  ...
  enum artco2_values { artco2_low,
                       ...
                       artco2_high,
                       artco2_arity };
  variable_h artco2 = u.new_finite_variable(artco2_arity);

  // Variable: catechol (33)
  enum catechol_values { catechol_normal,
                         catechol_high,
                         catechol_arity };
  variable_h catechol = u.new_finite_variable(catechol_arity);
  ...
  enum hr_values { hr_low,
                   ...
                   hr_high,
                   hr_arity };
  variable_h hr = u.new_finite_variable(hr_arity);
  ...
  enum co_values { co_low,
                   ...
                   co_high,
                   co_arity };
  variable_h co = u.new_finite_variable(co_arity);
  ...
  enum bp_values { bp_low,
                   ...
                   bp_high,
                   bp_arity };
  variable_h bp = u.new_finite_variable(bp_arity);

  /////////////////////////////// FACTORS /////////////////////////////

  vector<table_factor> factors;
  ...
  cluster_graph_model<table_factor> model;
  ...
  cluster_graph_model<table_factor> model2(model);
  ...
  assignment a;
  a[hypovolemia] = hypovolemia_true;
  a[lvfailure] = lvfailure_false;

  cout << "Model unnormalized likelihood for assignment " << a << ":\n"
       << model.log_likelihood(a) << std::endl;
