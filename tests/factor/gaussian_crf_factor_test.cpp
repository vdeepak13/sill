...
/**
 * \file gaussian_crf_factor_test.cpp  Test learning conditional Gaussians.
 * @todo Change this from a test of learn_crf_factor to a test of
 *       gaussian_crf_factor itself.
 */

static int usage() {
  std::cout << "usage: ./gaussian_crf_factor_test "
